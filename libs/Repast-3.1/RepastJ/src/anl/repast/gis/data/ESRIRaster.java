...
public class ESRIRaster {
  ...
  public IRasterDataset2 rasterDataset;
  public java.util.List properties = new ArrayList();
  ...
  public Point2D pixelToMap(int x, int y, int bandIndex) {
    RasterProperties props = (RasterProperties) properties.get(bandIndex);
    return props.MIDDLELEVELxelToMap(x, y);
  }
  ...
  public static void main(String[] args) {
    try {
      ...
      */
      ...
      System.out.println("raster.MIDDLELEVELxelToMap((int)point.getX(),  = " + raster.MIDDLELEVELxelToMap((int) point.getX(), (int)point.getY(), 0));

...
import com.bbn.openmap.util.Debug;
 ...
 public class RepastMapMouseInterpreter  implements MapMouseInterpreter { //extends StandardMapMouseInterpreter 
     ...
     public OMGraphicHandlerLayer layer = null;
     public String[] mouseModeServiceList = null;
     public String lastToolTip = null;
     public GestureResponsePolicy grp = null;
     public RepastGeometryOfInterest clickInterest = null;
     public RepastGeometryOfInterest movementInterest = null;
      ...
      */
     public void setClickInterest(RepastGeometryOfInterest goi) {
         clickInterest = goi;
     }
      ...
      * process of being clicked upon.
      */
     public RepastGeometryOfInterest getClickInterest() {
      ...
      * remains constant.
      */
     public void setMovementInterest(RepastGeometryOfInterest goi) {
      ...
      * remains constant.
      */
     public RepastGeometryOfInterest getMovementInterest() {
     ...
     public boolean noTimerOverOMGraphic = true;
      ...
      */
     public int mouseTimerInterval = 150;
      ...
      */
     public Timer mouseTimer = null;

     /**
      * The timer listener that calls updateMouseMoved.
      */
     public MouseTimerListener mouseTimerListener = new MouseTimerListener();
      ...
      */
     public boolean updateMouseMoved(MouseEvent e) {
         boolean ret = false;
         OMGraphic omg = getGeometryUnder(e);
      ...
      */
     public boolean displayPopup(List contents, MouseEvent me) {
         if (DEBUG) {
      ...
      */
     public void handleToolTip(String tip) {
         if (lastToolTip == tip) {
             return;
         }
         lastToolTip = tip;
      ...
      */
     public MouseEvent currentMouseEvent;

     /**
      * Set the last MouseEvent received.
      */
     public void setCurrentMouseEvent(MouseEvent me) {
...
//         this.rmmi = rmmi;
   //      leftButton = this.rmmi.isLeftMouseButton(me);
      ...
      * requirement.
      */
     public int getButton(MouseEvent me) {
         // jdk 1.4 version
         // return me.getButton();

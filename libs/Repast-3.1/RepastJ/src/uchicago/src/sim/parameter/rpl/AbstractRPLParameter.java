...
public abstract class AbstractRPLParameter implements RPLParameter {
  ...
  public String name;
  public List childParams = new ArrayList();
  public List childConsts = new ArrayList();
  ...
  public NumberConvertor convertor = null;
  ...
  public static Map convertors = new HashMap();
   ...
   */
  public abstract void invokeSet(SimModel model) throws RepastException;
  ...
  public void initWithModel(SimModel model) throws RepastException {
  ...
  public void setupParamArray(SimModel model) {
  ...
  public void createMethods(SimModel obj) throws RepastException {
    boolean found = false;

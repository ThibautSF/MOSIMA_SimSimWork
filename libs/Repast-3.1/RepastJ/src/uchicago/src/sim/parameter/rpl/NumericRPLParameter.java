...
public class NumericRPLParameter extends AbstractDynamicParameter {
  ...
  public BigDecimal start, end, curValue;
  public BigDecimal incr = new BigDecimal("1");
   ...
   */
  public void invokeSet(SimModel model) throws RepastException {
